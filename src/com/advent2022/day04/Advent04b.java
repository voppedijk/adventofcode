...
public class Advent04b {

	List<String> bestand;

	public static void main(String[] args) throws IOException {
		Advent04b aoc = new Advent04b();
		aoc.opdracht4();
	}
	...
	public void opdracht4() throws IOException {
		...
		while (teller < bestand.size()) {
			...
			if (deel1a >= deel2a && deel1a <= deel2b) {
				totaalAantalMetOverlap++;
			} else if (deel1b >= deel2a && deel1b <= deel2b) {
				totaalAantalMetOverlap++;
			} else if (deel2a >= deel1a && deel2a <= deel1b) {
				totaalAantalMetOverlap++;
			}
		...
		System.out.println("Antwoord Advent dag 4-2: " + totaalAantalMetOverlap);
